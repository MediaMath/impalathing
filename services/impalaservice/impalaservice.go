...
func (p TImpalaQueryOptions) String() string {
  ...
  case TImpalaQueryOptions_MAX_BLOCK_MGR_MEMORY: return "MAX_BLOCK_MGR_MEMORY"
...
func TImpalaQueryOptionsFromString(s string) (TImpalaQueryOptions, error) {
  ...
  case "MAX_BLOCK_MGR_MEMORY": return TImpalaQueryOptions_MAX_BLOCK_MGR_MEMORY, nil 
